...
export const initialMockIssues: Issue[] = [
  {
    ...
    description:
      "A huge, deep pothole has opened up right near the vegetable market entrance. It is filled with stagnant rainwater, making it highly invisible at night. Two motorcyclists have already slipped today. Need immediate patch repairs.",
    category: "Potholes",
    severity: "Critical",
    urgency: "Emergency",
    status: "In Progress",
  ...
  },
  {
    ...
    description:
      "An entire corner of the children's park has been converted into a trash dumpsite. Commercial waste, plastic crates, and medical waste have been dumped overnight. Stray dogs are scattering it and it smells horrible. Children can no longer play.",
  ...
  },
  {
    ...
    description:
      "The primary 10-inch water supply pipe has burst under the pavement. Fresh potable water is gushing out like a fountain. It has flooded the pedestrian walkway and is causing severe water logging on the road. Millions of gallons are wasting.",
  ...
  },
  {
    ...
    description:
      "A total of 8 streetlights are completely dead on lane 3 of Sector B. It creates a pitch-black zone in the evening which is highly unsafe for senior citizens and women walking home from the metro station.",
    category: "Streetlight Failure",
    severity: "Medium",
    urgency: "Normal",
    status: "Assigned",
    images: [
      "https://images.unsplash.com/photo-1509024644558-2f56ce76c490?q=80&w=600&auto=format&fit=crop",
    ],
    videos: [],
    location: {
      lat: 19.0812,
...
export const mockLeaderboard: LeaderboardEntry[] = [
  ...
  },
  {
    ...
    name: "Kabir Sen",
    points: 75,
    badges: ["Super Reporter"],
    rank: 5,
    area: "Ward 4 - Sector C",
  },
];

export const initialMockRewards = [
  {
    rewardId: "reward-1",
    title: "$10 Amazon Gift Card",
    description: "Redeem 100 civic points for a digital Amazon voucher.",
    pointCost: 100,
    stock: 8,
  ...
  },
  {
    ...
    description:
      "A reward for active civic participation and verified reports.",
    pointCost: 150,
    stock: 5,
  ...
  },
  {
    ...
    description:
      "A higher-tier reward for power users and community champions.",
    pointCost: 250,
    stock: 3,
